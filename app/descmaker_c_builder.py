...
def descmaker_c_builder(supervisors, global_event_list, base_dir, output_dir):
    """
    descmaker_c_builder
    """
    # make file events.c
    ...
    fill_template(f"{base_dir}/templates_c/template/src/event_handler/events-template.h",
                    f"{output_dir}/src/event_handler/events.h",
                    {'events_controllable_count': events_controllable_count,
                    'events_h': events_h})

    fill_template(f"{base_dir}/templates_c/template/src/event_handler/events-template.c",
                    f"{output_dir}/src/event_handler/events.c",
                    {'events_c': events_c,
                     'controllable_event_list':controllable_event_list})

    fill_template(f"{base_dir}/templates_c/template/src/main-template.c",
    ...
    for sup_index in range(len(supervisors)):
        ...
        fill_template(f"{base_dir}/templates_c/template/src/supervisors/supervisor-template.h",
    ...
    fill_template(f"{base_dir}/templates_c/template/src/supervisors/supervisor_list-template.c",
    ...
    fill_template(f"{base_dir}/templates_c/template/CMakeLists-template.txt",
