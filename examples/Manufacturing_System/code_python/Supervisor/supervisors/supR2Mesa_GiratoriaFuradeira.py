...
# Create transitions
S0_S0_S0_state.add_transition(Events['a2'], S1_S0_S1_state)
S0_S0_S0_state.add_transition(Events['a0'], S1_S1_S0_state)
S1_S0_S1_state.add_transition(Events['b2'], S0_S0_S0_state)
...
# create supervisor
supR2Mesa_GiratoriaFuradeira = Supervisor("supR2Mesa_GiratoriaFuradeira", state_list, alphabet)